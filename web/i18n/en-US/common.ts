const translation = {
  ...
  settings: {
    ...
    adConfig: 'Active Directory', // New key for AD Config
  },
  account: {
    account: 'Account',
    ...
    // AD Config specific translations
    adEnable: 'Enable Active Directory Authentication',
    adEnableTip: 'Allow users to log in using their Active Directory credentials.',
    adServerUrl: 'Server URL',
    adBindDN: 'Bind DN (Optional)',
    adBindPassword: 'Bind Password (Optional)',
    adPasswordPlaceholder: 'Leave blank to keep unchanged',
    adPasswordTip: 'The password for the Bind DN. It will be stored encrypted.',
    adUserSearchTitle: 'User Search Configuration',
    adUserSearchBase: 'User Search Base DN',
    adUserSearchFilter: 'User Search Filter',
    adGroupSearchTitle: 'Group Search Configuration (Optional)',
    adGroupSearchBase: 'Group Search Base DN',
    adGroupSearchFilter: 'Group Search Filter',
    adAttributeMappingTitle: 'Attribute Mapping',
    adAttrUsername: 'Username Attribute',
    adAttrEmail: 'Email Attribute',
    adAttrDisplayName: 'Display Name Attribute',
    adTestConnection: 'Test Connection',
